...
Легковагова система централізованого збору журналів подій та виявлення інцидентів безпеки для корпоративної мережі підприємства (MVP). Проєкт розроблено в межах навчальної технологічної практики за спеціальністю 122 «Комп'ютерні науки».
...
2. Запуск сховища Loki:
   docker compose up -d

3. Підготовка оточення та запуск бекенду:
   python3 -m venv venv
...
Документація REST API доступна за адресою: http://<IP_СЕРВЕРА>:8000/docs
